...
export function getInitialClassification() {
	return classification(getStartImage()).clip(getAOI())
}

export function getFinalClassification() {
	return classification(getRecentImage()).clip(getAOI())
}
